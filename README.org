...
#+begin_src cg
ADD (&syn-delete-adv-phrasal-verb) TARGET (Adv) IF (0 ("bæjjese")) (-1 ("tjuedtjielidh")) ;

ADDRELATION (DELETE1) (V &syn-delete-adv-phrasal-verb) TO (1 Adv &syn-delete-adv-phrasal-verb)
#+end_src
